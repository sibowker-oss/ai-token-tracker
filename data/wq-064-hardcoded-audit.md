...
- **Brief A: Wire methodology page constants.** `methodology_constant` candidates appear in 2 file(s) (capital.html, methodology.html). Move shared rates / percentages into a config file the renderer reads.
- **Brief B: Wire per-entity metric blocks.** `per_entity_metric` candidates in 16 file(s). Replace hand-edited valuations / user counts / ARR with reads from entities.json:companies[*].current.
...
- **Brief E: Compute derived ratios in JS, not literals.** `ratio_derived` candidates in 4 file(s). Ratios should be computed at render time from the values they reference, never typed in directly.
...
| Line | Value | Context | Semantic |
|---|---|---|---|
| 117 | `$15` | line.investment_to_revenue_ratio_label">$15:$1</span> investment ratio | per_entity_metric |
| 117 | `$1` | .investment_to_revenue_ratio_label">$15:$1</span> investment ratio?</b | per_entity_metric |
...
### `capital.html` (85 values)

- YES (should derive): 56
- NO (factual / fixed): 0
- UNCLEAR: 29
...
| 230 | `$1` | lative.infra_to_revenue_ratio_2025">$34:$1</strong> to <strong id="cf- | market_aggregate |
| 230 | `$13` | a_to_revenue_ratio_2025_excl_self_use">~$13:$1</strong>. | market_aggregate |
| 230 | `$1` | _revenue_ratio_2025_excl_self_use">~$13:$1</strong>. | market_aggregate |
...
| 195 | `$260B` | dline.annual_ai_investment_usd_b_label">$260B</span>/yr (<span data-me | market_aggregate |
| 195 | `$711M` | nual_ai_investment_per_day_usd_m_label">$711M</span>/day). Rate cards, | market_aggregate |
| 195 | `$15` | line.investment_to_revenue_ratio_label">$15:$1</span>" context.</p> | market_aggregate |
| 195 | `$1` | .investment_to_revenue_ratio_label">$15:$1</span>" context.</p> | market_aggregate |
...
### `index.html` (33 values)

- YES (should derive): 17
- NO (factual / fixed): 0
- UNCLEAR: 16
